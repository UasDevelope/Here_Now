...
import 'package:here_now/app/modules/home/widget/shimmer_comment_container.dart';
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor: Colors
                              .transparent, // Use transparent to inherit container color
...
Future<void> newsCommentsBottomSheet({
  required TextEditingController commentController,
  required VoidCallback onSendComment,
}) {
  return Get.bottomSheet(
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Comments List
              Obx(() {
                final comments = ControllerLocator.homeController;
                return comments.commentLoading.value
                    ? Expanded(
                        child: ListView.builder(
                          padding: EdgeInsets.zero,
                          itemCount: 6, // Show 6 shimmer placeholders
                          itemBuilder: (context, index) =>
                              const ShimmerCommentContainer(),
                        ),
                      )
                    : comments.commentList.isEmpty
                        ...
                        : Expanded(
                            child: ListView.builder(
                              padding: EdgeInsets.zero,
                              itemCount: comments.commentList.length,
                              itemBuilder: (context, index) {
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  DateTimeUtils.formatToDmy(comment
                                                      .createdAt), // Fallback to an empty string if createdAt is null
                                                  style: AppStyle.openSans(
                                                    color: Colors.grey,
                                                    fontSize: 10,
                                                    fontWeight: FontWeight.w400,
